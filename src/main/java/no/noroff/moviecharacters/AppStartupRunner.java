...
public class AppStartupRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (movieRepository.count() == 0) {
            ...
            // HARRY POTTER
            Movie hpPhilosophersStone = new Movie( "Harry Potter and the Philosopher's Stone", "Fantasy", 2001, "Chris Columbus", "", "https://www.youtube.com/watch?v=VyHV0BRtdxo", Set.of(danielRadcliffe, emmaWatson, rupertGrint), harryPotter);
            Movie hpChamberOfSecrets = new Movie( "Harry Potter and the Chamber of Secrets", "Fantasy", 2002, "Chris Columbus", "", "https://www.youtube.com/watch?v=1bq0qff4iF8", Set.of(danielRadcliffe, emmaWatson, rupertGrint), harryPotter);
            Movie hpDeathlyHallowsOne = new Movie( "Harry Potter and the Deathly Hallows: Part 1", "Fantasy", 2010, "David Yates", "", "https://www.youtube.com/watch?v=MxqsmsA8y5k", Set.of(danielRadcliffe, emmaWatson, rupertGrint), harryPotter);
            Movie hpDeathlyHallowsTwo = new Movie( "Harry Potter and the Deathly Hallows: Part 2", "Fantasy", 2011, "David Yates", "", "https://www.youtube.com/watch?v=mObK5XD8udk", Set.of(danielRadcliffe, emmaWatson, rupertGrint), harryPotter);

            // LORD OF THE RINGS
            Movie lotrAnimated = new Movie( "The Lord of the Rings", "Animation, Fantasy", 1978, "Ralph Bakshi", "", "https://www.youtube.com/watch?v=Y46VsU2RhrM", Set.of(johnHurt), lordOfTheRings);
            Movie lotrFellowshipOfTheRing = new Movie( "The Lord of the Rings: Fellowship of the Ring", "Fantasy", 2001, "Peter Jackson", "", "https://www.youtube.com/watch?v=V75dMMIW2B4", Set.of(elijahWood, ianMcKellen, cateBlanchett), lordOfTheRings);
            Movie lotrTheTwoTowers = new Movie( "The Lord of the Rings: The Two Towers", "Fantasy", 2002, "Peter Jackson", "", "https://www.youtube.com/watch?v=LbfMDwc4azU", Set.of(elijahWood, ianMcKellen, cateBlanchett), lordOfTheRings);
            Movie lotrReturnOfTheKing = new Movie( "The Lord of the Rings: Return of the King", "Fantasy", 2003, "Peter Jackson", "", "https://www.youtube.com/watch?v=LbfMDwc4azU", Set.of(elijahWood, ianMcKellen, cateBlanchett), lordOfTheRings);
